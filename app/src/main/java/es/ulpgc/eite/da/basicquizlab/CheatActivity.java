...
public class CheatActivity extends AppCompatActivity {
  ...
  public final static String CHEATED_SHOW ="EXTRA_SHOW";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if(savedInstanceState!=null){
      ...
      currentAnswer=savedInstanceState.getInt(CHEATED_SHOW);
    }
    enableLayoutButtons();
  }
  ...
  protected void onSaveInstanceState(@NonNull Bundle outState) {
   ...
   //  outState.putBoolean(CHEATED_SHOW,answerCheated);
     outState.putBoolean(EXTRA_CHEATED,answerCheated);
     outState.putInt(CHEATED_SHOW,currentAnswer);
